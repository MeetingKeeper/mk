...
import {coming_soon_data} from '../../data/coming_soon_data';

const Services = () => {
  return (
    <section className="py-24 dark:bg-jacarta-900 w-full">
      <div className="container">
        <div className="mx-auto mb-12 max-w-xl text-center">
          ...
          <p className="text-lg dark:text-jacarta-300">
            PlanMeet.ai is an upcoming cutting-edge platform designed to revolutionize meeting efficiency and
            productivity.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {coming_soon_data.map((item) => {
            ...
            return (
              ...
              >
                <span
                  className="absolute top-10 left-12 block h-10 w-10 rounded-full bg-[#DCD0FF] dark:bg-accent"></span>
